...
public class Utils {
    ...
    @SuppressWarnings({"unchecked"})
    public static void addVehicleToVehicleManager(VehicleManager vehicleManager,
                                                  Vehicle vehicle,
                                                  VehicleManager.Occupied<?> occupied) throws
                                                                                       ReflectiveOperationException {
        ...
        Constructor<?> constructor = Class.forName("projekt.delivery.routing.AbstractOccupied$VehicleStats")
                                          .getDeclaredConstructor(long.class, VehicleManager.Occupied.class);
        constructor.setAccessible(true);
    ...
    public static void setOrdersOfVehicle(Vehicle vehicle, List<ConfirmedOrder> orders) throws
                                                                                        ReflectiveOperationException {
    ...
    public static void callPutNode(Region region, Region.Node node) throws ReflectiveOperationException {
        Method method = region.getClass()
                              .getDeclaredMethod("putNode", Class.forName("projekt.delivery.routing.NodeImpl"));
    ...
    public static void callPutEdge(Region region, Region.Edge edge) throws ReflectiveOperationException {
        Method method = region.getClass()
                              .getDeclaredMethod("putEdge", Class.forName("projekt.delivery.routing.EdgeImpl"));
        method.setAccessible(true);
    ...
    public static void mockPathCalculator(VehicleManager vehicleManager) throws ReflectiveOperationException {
        ...
        Field pathCalculatorField = Class.forName("projekt.delivery.routing.VehicleManagerImpl")
                                         .getDeclaredField("pathCalculator");
        pathCalculatorField.setAccessible(true);
        pathCalculatorField.set(vehicleManager, pathCalculator);
    }

    public static Vehicle.Path createPath(Deque<Region.Node> nodes,
                                          BiConsumer<? super Vehicle, Long> arrivalAction) throws
                                                                                           ReflectiveOperationException {
        Constructor<?> constructor = Class.forName("projekt.delivery.routing.VehicleImpl$PathImpl")
                                          .getDeclaredConstructor(Deque.class, BiConsumer.class);
        constructor.setAccessible(true);
    ...
    @SuppressWarnings("unchecked")
    public static Map<Region.Edge, VehicleManager.Occupied<Region.Edge>> callToOccupiedEdges(VehicleManager vehicleManager,
                                                                                             Collection<Region.Edge> edges) throws
                                                                                                                            ReflectiveOperationException {
    ...
    public static void setOccupiedEdgeOfVehicleManager(VehicleManager vehicleManager,
                                                       Map<Region.Edge, VehicleManager.Occupied<Region.Edge>> map) throws
                                                                                                                   ReflectiveOperationException {
    ...
    @SuppressWarnings("unchecked")
    public static Set<VehicleManager.Occupied<?>> callGetAllOccupied(VehicleManager vehicleManager) throws
                                                                                                    ReflectiveOperationException {
    ...
    @SuppressWarnings("unchecked")
    public static VehicleManager.Occupied<Region.Node> createOccupiedNode(VehicleManager vehicleManager,
                                                                          Region.Node node) throws
                                                                                            ReflectiveOperationException {
        Constructor<?> constructor = Class.forName("projekt.delivery.routing.OccupiedNodeImpl")
                                          .getDeclaredConstructor(Region.Node.class, VehicleManager.class);
        constructor.setAccessible(true);
        return (VehicleManager.Occupied<Region.Node>) constructor.newInstance(node, vehicleManager);
    }

    @SuppressWarnings("unchecked")
    public static VehicleManager.Occupied<Region.Edge> createOccupiedEdge(VehicleManager vehicleManager,
                                                                          Region.Edge edge) throws
                                                                                            ReflectiveOperationException {
        Constructor<?> constructor = Class.forName("projekt.delivery.routing.OccupiedEdgeImpl")
                                          .getDeclaredConstructor(Region.Edge.class, VehicleManager.class);
        constructor.setAccessible(true);
        return (VehicleManager.Occupied<Region.Edge>) constructor.newInstance(edge, vehicleManager);
    }

    @SuppressWarnings("unchecked")
    public static VehicleManager.Occupied<Region.Neighborhood> createOccupiedNeighborhood(VehicleManager vehicleManager,
                                                                                          Region.Neighborhood neighborhood) throws
                                                                                                                            ReflectiveOperationException {
        Constructor<?> constructor = Class.forName("projekt.delivery.routing.OccupiedNeighborhoodImpl")
                                          .getDeclaredConstructor(Region.Neighborhood.class, VehicleManager.class);
        constructor.setAccessible(true);
        return (VehicleManager.Occupied<Region.Neighborhood>) constructor.newInstance(neighborhood, vehicleManager);
    }

    @SuppressWarnings("unchecked")
    public static VehicleManager.Occupied<Region.Restaurant> createOccupiedRestaurant(VehicleManager vehicleManager,
                                                                                      Region.Restaurant restaurant) throws
                                                                                                                    ReflectiveOperationException {
        Constructor<?> constructor = Class.forName("projekt.delivery.routing.OccupiedRestaurantImpl")
                                          .getDeclaredConstructor(Region.Restaurant.class, VehicleManager.class);
        constructor.setAccessible(true);
    ...
    public static Map<ProblemArchetype, Simulation> callCreateSimulations(RunnerImpl runner,
        ...
        Method method = runner.getClass()
                              .getDeclaredMethod("createSimulations",
                                                 ...
                                                 DeliveryService.Factory.class);
        method.setAccessible(true);
        return (Map<ProblemArchetype, Simulation>) method.invoke(runner,
                                                                 problemGroup,
                                                                 simulationConfig,
    ...
    @SuppressWarnings("unchecked")
    public static Map<RatingCriteria, Rater.Factory> getRaterFactoryMap(Simulation simulation) throws
                                                                                               ReflectiveOperationException {
    ...
    public static OrderGenerator.Factory getOrderGeneratorFactory(Simulation simulation) throws
                                                                                         ReflectiveOperationException {
    ...
    @SuppressWarnings("unchecked")
    public static List<Event> callTick(BasicDeliveryService basicDeliveryService,
                                       long currentTick,
                                       List<ConfirmedOrder> newOrders) throws ReflectiveOperationException {
    ...
    @SuppressWarnings("unchecked")
    public static void addPendingOrders(BasicDeliveryService basicDeliveryService, List<ConfirmedOrder> orders) throws
                                                                                                                ReflectiveOperationException {
    ...
    @SuppressWarnings("unchecked")
    public static List<ConfirmedOrder> getPendingOrders(BasicDeliveryService basicDeliveryService) throws
                                                                                                   ReflectiveOperationException {
        Field pendingOrders = basicDeliveryService.getClass().getDeclaredField("pendingOrders");
        pendingOrders.setAccessible(true);
    ...
    @SuppressWarnings("unchecked")
    public static Map<Region.Node, VehicleManager.Occupied<? extends Region.Node>> getOccupiedNodes(VehicleManager vehicleManager) throws
                                                                                                                                   ReflectiveOperationException {
        Field occupiedNodesField = vehicleManager.getClass().getDeclaredField("occupiedNodes");
        occupiedNodesField.setAccessible(true);
    ...
    public static void setOccupiedNodes(VehicleManager vehicleManager,
                                        Map<Region.Node, VehicleManager.Occupied<? extends Region.Node>> map) throws
                                                                                                              ReflectiveOperationException {
        Field occupiedNodesField = vehicleManager.getClass().getDeclaredField("occupiedNodes");
        occupiedNodesField.setAccessible(true);
    ...
    public static void setOccupiedOfVehicle(Vehicle vehicle, VehicleManager.Occupied<?> occupied) throws
                                                                                                  ReflectiveOperationException {

...
public class TutorTests_H4_EdgeImplTest {
    ...
    public void testCompareToEqual() {
        ...
        assertEquals(0,
                     ...
                     context,
                     TR -> "The method did not return 0 when the edges are the same.");
    }
    ...
    public void testEquals() throws ReflectiveOperationException {
        ...
        assertFalse(edgeAB.equals(new Object()),
                    context,
                    TR -> "The method did not return false when the object is not an EdgeImpl.");
        ...
        assertFalse(edgeAB.equals(differentName),
                    context,
                    TR -> "The method did not return false when the object has a different name.");
    }

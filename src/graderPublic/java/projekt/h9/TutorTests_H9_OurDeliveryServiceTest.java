...
public class TutorTests_H9_OurDeliveryServiceTest {
    ...
    public void testProblem1(int runs) throws IOException {
        ...
        ProblemGroup problemGroup = new ProblemGroupImpl(List.of(problem1),
                                                         List.of(RatingCriteria.AMOUNT_DELIVERED,
    ...
    public void testProblem2(int runs) throws IOException {
        ...
        ProblemGroup problemGroup = new ProblemGroupImpl(List.of(problem2),
                                                         List.of(RatingCriteria.AMOUNT_DELIVERED,
                                                                 RatingCriteria.IN_TIME,
                                                                 RatingCriteria.TRAVEL_DISTANCE));
    ...
    public void testProblem3(int runs) throws IOException {
        ...
        ProblemGroup problemGroup = new ProblemGroupImpl(List.of(problem3),
                                                         List.of(RatingCriteria.AMOUNT_DELIVERED,
                                                                 RatingCriteria.IN_TIME,
                                                                 RatingCriteria.TRAVEL_DISTANCE));
    ...
    public void testProblem4(int runs) throws IOException {
        ...
        ProblemGroup problemGroup = new ProblemGroupImpl(List.of(problem4),
                                                         List.of(RatingCriteria.AMOUNT_DELIVERED,
                                                                 RatingCriteria.IN_TIME,
                                                                 RatingCriteria.TRAVEL_DISTANCE));

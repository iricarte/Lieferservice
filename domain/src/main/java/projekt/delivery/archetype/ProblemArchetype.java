 ...
 *
 * <ul>
 *     <li>A {@link OrderGenerator.Factory} that creates a {@link OrderGenerator} that will
 *     create orders during a simulation.</li>
 *     <li>A {@link VehicleManager} that describes the setup of the underlying region in which
 *     will be simulated including information about the
 *     available vehicles.</li>
 *     <li>A {@link Map} that indicates which {@link Rater} is used for every
 *     {@link RatingCriteria} to evaluate the given simulation.</li>

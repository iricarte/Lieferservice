...
/**
 * Indicates that a {@link Vehicle} delivered a {@link ConfirmedOrder} to a
 * {@link Region.Neighborhood}.
 */
public interface DeliverOrderEvent extends VehicleEvent {

    static DeliverOrderEvent of(long tick, Vehicle vehicle, Region.Neighborhood node, ConfirmedOrder order) {

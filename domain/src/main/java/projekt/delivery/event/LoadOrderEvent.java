...
/**
 * Indicates that a {@link Vehicle} loaded a {@link ConfirmedOrder} from a
 * {@link projekt.delivery.routing.Region.Restaurant}.
 */
public interface LoadOrderEvent extends VehicleEvent {

    static LoadOrderEvent of(long tick, Vehicle vehicle, ConfirmedOrder order, Region.Restaurant restaurant) {

...
public interface Region {
     ...
     * @return The {@link Region.Node} at the given {@link Location} or null if there is no
     * {@link Region.Node} at the given {@link Location}.
     */
     ...
     * @return The {@link Region.Edge} connecting the two given {@link Region.Node}s or null if
     * the two {@link Region.Node}s are not directly
     * connected.
     */
     ...
     * @return The {@link Region.Edge} connecting the two given {@link Location}s or null if the
     * two {@link Location}s are not directly connected.
     */
    ...
    interface Node extends Component<Node> {
        ...
        /**
         * Returns the {@link Region.Edge} that connects this {@link Node} to the given
         * {@link Node}.
         *
         * @param other The {@link Node} the {@link Region.Edge} to is searched.
         * @return The {@link Region.Edge} that connects this {@link Node} to the given
         * {@link Node} or null if the {@link Node}s are not directly
         * connected.
         */
    ...
    interface Restaurant extends Node {
        ...
        Preset LOS_FOPBOTS_HERMANOS = new Preset("Los Fopbots Hermanos",
                                                 List.of("Pizza Margherita", "Spaghetti Bolognese", "Rigatoni"));

        Preset JAVA_HUT = new Preset("Java Hut", List.of("Pizza Margherita", "Spaghetti Bolognese", "Rigatoni"));

        Preset PASTAFAR = new Preset("Pastafar", List.of("Pizza Margherita", "Spaghetti Bolognese", "Rigatoni"));

        Preset PALPAPIZZA = new Preset("Palpapizza", List.of("Pizza Margherita", "Spaghetti Bolognese", "Rigatoni"));

        Preset ISENJAR = new Preset("Isenjar", List.of("Pizza Margherita", "Spaghetti Bolognese", "Rigatoni"));

        Preset MIDDLE_FOP = new Preset("Middle Fop", List.of("Pizza Margherita", "Spaghetti Bolognese", "Rigatoni"));

        Preset MOUNT_DOOM_PIZZA = new Preset("Mount Doom Pizza",
                                             List.of("Pizza Margherita", "Spaghetti Bolognese", "Rigatoni"));
    ...
    interface Builder {
        ...
        /**
         * Checks if a {@link Node} with the given values can be added to the constructed
         * {@link Region}.<p>
         * <p>
         * If this method returns true, the very next call to {@link #addNode(String, Location)}
         * with the same parameter
         * will not result in an exception.
         *
         * @param name     The name to check.
         * @param location The {@link Location} to check.
         * @return True, if a {@link Node} with the given name and {@link Location} can be added
         * to the constructed {@link Region}.
         */
         ...
         *
         * @param location         The {@link Location} of the new {@link Restaurant}.
         * @param restaurantPreset The {@link Restaurant.Preset} used to create the new
         *                         {@link Restaurant}.
         * @return The current {@link Builder}.
         */
        ...
        /**
         * Checks if a {@link Edge} with the given values can be added to the constructed
         * {@link Region}.<p>
         * <p>
         * If this method returns true, the very next call to
         * {@link #addEdge(String, Location, Location)} with the same parameter
         * will not result in an exception.
         *
         * @param name      The name to check.
         * @param locationA The first {@link Location} to check.
         * @param locationB The second {@link Location} to check.
         * @return True, if a {@link Edge} with the given name and {@link Location}s can be added
         * to the constructed {@link Region}.
         */

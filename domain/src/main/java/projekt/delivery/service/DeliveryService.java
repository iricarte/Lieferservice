...
/**
 * Manages all incoming {@link ConfirmedOrder}s and assigns task to the {@link Vehicle}s of the
 * underlying {@link VehicleManager}.
 */
public interface DeliveryService {
    ...
    /**
     * Adds a {@link List} of {@link ConfirmedOrder}s to the pending orders of this
    ...
    /**
     * Returns all pending {@link ConfirmedOrder}s that are supposed to be delivered some time in
     * the future.
     *
     * @return All pending {@link ConfirmedOrder}s that are supposed to be delivered some time in
     * the future.
     */

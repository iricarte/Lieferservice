 ...
 * It allows {@link SimulationListener}s to be registered via the
 * {@link #addListener(SimulationListener)} method.
 */
public interface Simulation {
     ...
     * To terminate the simulation, you need to call {@link #endSimulation()} from a separate
     * thread.
     */
    void runSimulation();
     ...
     * To terminate the simulation, you can also call {@link #endSimulation()} from a separate
     * thread.
     *
     * @param maxTicks The maximum amount of ticks the simulation will run.
     *                 When the maximum amount of ticks is reached the simulation will be stopped
     *                 automatically.
     */
     ...
     * @throws IllegalArgumentException If no {@link Rater} is registered for the given
     *                                  {@link RatingCriteria}.
     */
